...
if __name__ == "__main__":
    print('Image for recognition: ' + str(image_path.value))
    model = emnist_model()

    model = keras.models.load_model('D:\\Work\\EKON25\\ML\\emnist_letters.h5')
    s_out = img_to_str(model, 'D:\\Work\\EKON25\\Images\\ekon25.png')
    keras_recognized_text.value = s_out
    print(s_out)