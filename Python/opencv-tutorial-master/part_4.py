...
def find_features(img1):
    correct_matches_dct = {}
    directory = 'C:/Work/Examples/opencv-tutorial-master/images/cards/sample/'
...
if __name__ == '__main__':
    main_image = cv2.imread('C:/Work/Examples/opencv-tutorial-master/images/cards/main_image/cards.JPG')
